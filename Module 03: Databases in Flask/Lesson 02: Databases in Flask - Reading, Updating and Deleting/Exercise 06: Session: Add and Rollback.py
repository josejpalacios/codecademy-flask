# Database transaction: A set of operations such as addition, removal, or updating database entries
# Database session: Consists of one or more transactions.

# Committing: Ends a transaction by saving the transactions permanently to the database.
# Rollback: Rejects the pending transactions and changes are not permanently saved in the database.

# add(): Used to add entry to session
# commit(): Permanently write changes in a session
