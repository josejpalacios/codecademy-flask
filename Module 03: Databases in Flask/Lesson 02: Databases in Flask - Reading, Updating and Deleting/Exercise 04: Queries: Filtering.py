# .filter(): Filter a query
# .filter_by(): Uses only a simple attribute-value test for filtering.
...
# * .count(): Counts the number of fetched entries
# * .first(): Returns only one result, namely the first one.

# Multiple criteria may be specified as comma separated
# and the interpretation of a comma is a Boolean (and)
