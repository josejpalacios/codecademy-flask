# The Models created have relationships.

# Fetching many objects:
# Fetch related objects of some object by accessing its attribute defined with .relationship().
# Example:
# reader = Reader.query.get(123)
# reviews_123 = reader.reviews.all()

# Fetching one object:
# Fetch one object of some object by accessing its backref field specified in TableName’s .relationship() attribute.
# Example:
